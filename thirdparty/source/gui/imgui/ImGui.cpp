...
/*
 ...
 - Add the Dear ImGui source files + selected back-end source files to your projects or using your preferred build system.
   It is recommended you build and statically link the .cpp files as part of your project and NOT as accessors library (DLL).
 ...
 - 2018/02/07 (1.60) - reorganized context handling to be more explicit,
                       ...
                       - removed allocator parameters from CreateContext(), they are now setup with SetAllocatorFunctions(), and accessors by all contexts.
...
// 1) Important: globals are not accessors across DLL boundaries! If you use DLLs or any form of hot-reloading: you will need to call
...
void ImGui::NewFrame()
{
    ...
    // Setup current font and draw list accessors data
